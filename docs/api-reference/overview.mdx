...
<CardGroup cols={2}>
  ...
  <Card
    ...
    color="#FF4785"
  >
    Generate Playwright/Vitest tests
  </Card>
  <Card
    title="generate_docs"
    icon="book"
...
<Tabs>
  ...
  <Tab title="Generation">
    ...
    - `generate_test` - Test files
    - `generate_docs` - MDX documentation
...
This package is [MIT licensed](https://opensource.org/licenses/MIT). All tools are available without a license key.
...
| 2000-2099 | Reserved | (legacy codes; unused) |
